...
(function(){
  ...
  var modules = [
    ...
    { label: 'Visualize photoreal panel', url: withV('js/ui/visualize-photoreal.js'), critical: false },
    { label: 'DA Workflow Core', url: withV('js/ui/da-workflow.js'), critical: false },
    { label: 'DA Workflow UI', url: withV('js/ui/da-ui.js'), critical: false },
